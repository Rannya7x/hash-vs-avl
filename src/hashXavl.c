...
int main(){
    for(int i=0;i<1;i++){
        ...
        while((sensor_avl = ler_sensor(medidas))!=NULL){
            ...
            free(sensor_avl);
            printf("Inserção na AVL concluída para chave %d.\n", chave);
